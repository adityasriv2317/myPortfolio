...
const Logo = () => {
  ...
  return (
    <div
      className="flex logo text-[rgba(255,255,255,0.8)] hover:text-white hover:[text-shadow:0px_0px_7px_rgba(255,255,255,0.4)] items-center text-3xl text-center cursor-pointer"
    ...
    >
      ...
      <div className="name hover:font-medium font-light duration-1000 transition-all">
        ...
        <span className="font-light [text-shadow:0px_0px_7px_rgba(255,255,255,0.8)]">{displayName.slice(6)}</span>
      </div>
      <div className="font-light">&gt;</div>
    </div>
  );
