...
const Home = () => {
  ...
  return (
    <div className="flex flex-col md:flex-row h-screen text-white px-8 md:px-24 py-10 md:py-20">
      ...
      {/* main content*/}
      <div className="right w-3/4 not-md:w-full md:px-20 py-2 max-h-max overflow-y-scroll">
